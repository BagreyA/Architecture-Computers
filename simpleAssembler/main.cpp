//Проверяет наличие правильного количества аргументов командной строки
#include <iostream>
#include <fstream>
#include <sstream>
#include <string>
...
std::vector<int> codes = vector<int>(128);
...
void parse_line(string line)
{
    ...
    if (tokens.size() < 3)
    {
        cerr << "Недопустимая строка: " << line << endl;
        exit(-1);
    }
...
int main(int argc, char **argv)
{
    if (argc < 2)
    {
        cout << "Первым аргументом должен быть путь!" << endl;
        return -1;
    }
